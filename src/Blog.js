...
function Blog(){
    ...
    return(
        ...
        <div className="content notHomeContent">
            ...
            <CardHorizontal title="share n learn probalby i guess pt1" content="none loser"  img={demo1}></CardHorizontal>
            ...
            <CardHorizontal title="share n learn probalby i guess pt2" content="none loser"  img={demo1}></CardHorizontal>
            <CardHorizontal title="share n learn probalby i guess pt3" content="none loser" img={demo1}></CardHorizontal>
