    ...
    return(
        <div className="content">
            ...
            <div className="news section lightBlue">
                ...
                Congratulation to the champions and thanks to APL for hosting this event!"></CardVertical>
            </div>
